...
<div class="page-terminos page-mh-full">
    <div class="container-1220">

        <h2 class="title">Preguntas Frecuentes</h2>
        
        <div class="page-terminos-cont">
            ...
            <p>
                Las transacciones de esta plataforma estan protegidas por openpay para mayor información consultar https://www.openpay.mx
            </p>

...
<?=Yii::$app->request->csrfParam?>" value="<?=Yii::$app->request->csrfToken?>"/>
                ...
                <div class=" col-md-2">
                    ...
                    <input class="form-control" id="ancho" name="ancho" value="10">
                </div>

                <div class=" col-md-2">
                    <label for="largo">Largo CM</label>
                    <input class="form-control" id="largo" name="largo" value="10">
                </div>

                <div class=" col-md-2">
                    <label for="alto">alto CM</label>
                    <input class="form-control" id="alto" name="alto" value="10">
                </div>
...
var url = "http://localhost/2018/envios_360/web/services/request-cotizacion-paquete";
        ...
        $.ajax({
            ...
            success: function(msg,status,xhr) {
                ...
                for(i=0; i < msg.length; i++){
                    ...
                    row += "<td>" + cotizacion['serviceType'] + " - " + cotizacion['servicePacking'] + "</td>";
                    row += "<td>" + cotizacion['deliveryDate'] + "</td>";
                    row += "<td>" + cotizacion['price'] + "</td>";
                    row += "<td>" + cotizacion['tax'] + "</td>";
                    row += "<td>" + cotizacion['currency'] + "</td>";
                    row += "<td><a  href='<?=Url::base()?>/site/purchase-paquete?carrier=" + cotizacion['provider'] + 

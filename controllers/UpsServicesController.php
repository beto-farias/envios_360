...
class UpsServicesController extends \yii\rest\Controller{

    
    const USUARIO = 'Mexico01';
    const PASSWORD = 'W1R182.api3';
    const LICENCE_NUMBER = 'AD47969AD626DA78';
    ...
    public function actionValidateService(){
        ...
        $data = [];
        $data['AccessRequest'] = [];
        $data['AccessRequest']['AccessLicenseNumber'] = $this::LICENCE_NUMBER;
        $data['AccessRequest']['UserId'] = $this::USUARIO;
        $data['AccessRequest']['Password'] = $this::PASSWORD;
        $data['AddressValidationRequest']['Request']['TransactionReference']['CustomerContext'] = '';
        $data['AddressValidationRequest']['Request']['RequestAction'] = 'AV';
        $data['AddressValidationRequest']['Address']['CountryCode']= $json->recipient->country_code;
        //$data['AddressValidationRequest']['Address']['City']=
        //$data['AddressValidationRequest']['Address']['StateProvinceCode']=
        $data['AddressValidationRequest']['Address']['PostalCode']= $json->recipient->postal_code;

        $endpoint = $this->URL_SERVICE . 'AV';

        $response = $this->jsonRequest($endpoint, $data);
